...
## [2.2.0](https://github.com/dscheerens/ngx-extended-async-pipe/compare/v2.1.0...v2.2.0) (2024-10-05)


### Features

* added an opt-in for local change detection by providing `enableExtendedAsyncPipeLocalChangeDetection(...)` with an optional configuration
